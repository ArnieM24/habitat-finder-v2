...
import { signInWithGoogle, signup } from "../login/action";
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4">
        ...
        <div className="w-full max-w-md bg-white text-black rounded-xl shadow-lg p-6 space-y-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-neutral-500">Or continue sign up with</span>
            <hr className="flex-grow border-neutral-700" />
          </div>
          ...
          <form className="space-y-4">
            ...
            <button type="submit" formAction={signup} className="w-full py-2 bg-[hsl(21,100%,50%)] text-white font-semibold rounded hover:bg-[hsl(21,100%,60%)] transition cursor-pointer">
              Sign Up
            </button>

            <p className="text-sm text-center text-neutral-500">
              Already have an account?
              <Link href="/auth/login" className="text-blue-400 hover:underline ml-1">
                Login
              </Link>
            </p>
          </form>
